...
class BankAccountViewController: ParentLoadingViewController , STPPaymentCardTextFieldDelegate, UITextFieldDelegate{
    ...
    override func viewDidLoad() {
        ...
        descriptionAccount = UILabel(frame: CGRect(x: 20, y: textField3.yBottom() + 5, width: Brain.kLargeurIphone - 40, height: 70))
        ...
        descriptionAccount.text = NSLocalizedString("This bank account will allow you to receive your weekly transfers from GoRush. 4 working days delay. The bank account must be a Canadian account. GoRush uses Stripe to secure bank payments. Powered by Stripe.com", comment: "")
        ...
        PFCloud.callFunction(inBackground: "RetreiveAccountBusinessAccount", withParameters: ["userId":PFUser.current()!.objectId!], block: { (object, error) in
            ...
            if error != nil {
                ...
                DispatchQueue.main.async {
                    ...
                    okAction.setValue(Brain.kColorMain, forKey: "titleTextColor")
                ...
                self.descriptionAccount.text = NSLocalizedString("This bank account will allow you to receive your weekly transfers from GoRush. 4 working days delay. The bank account must be a Canadian account. GoRush uses Stripe to secure bank payments. Powered by Stripe.com", comment: "")
   ...
   @objc func touchNext(_ sender: UIButton){
    ...
    func popupBankAccountUpdated(){
        ...
        let alert = UIAlertController(title: NSLocalizedString("Congratulations", comment: ""), message: NSLocalizedString("Your bank account has been updated. You will now receive all your jobs on this one", comment: ""), preferredStyle: UIAlertControllerStyle.alert)
